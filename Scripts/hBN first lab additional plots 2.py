...
plt.figure(64)
plt.title('Detection of X-Rays Al,O (250nm) (Normalised)')
plt.xlabel('Beam Energy (keV)')
plt.ylabel('Intensity (Arb. Units)')
plt.plot(BeamEnergy,(Ray_AbsorbAl_250 / max(Ray_AbsorbAl_250)), label = 'I_emit (Al)', marker = 'x', color = 'lime', linestyle = 'dotted')
plt.plot(BeamEnergy,(Ray_DetectAl_250 / max(Ray_DetectAl_250)), label = 'I_detected (Al)', marker = 'x', color = 'green', linestyle = 'dotted')
plt.plot(BeamEnergy,(Ray_AbsorbO_250 / max(Ray_AbsorbO_250)), label = 'I_emit (O)', marker = 'o', color = 'maroon', linestyle = 'dotted')
plt.plot(BeamEnergy,(Ray_DetectO_250 / max(Ray_DetectO_250)), label = 'I_detected (O)', marker = 'o', color = 'red', linestyle = 'dotted')
plt.legend()


plt.figure(74)
plt.title('Detection of X-Rays B,N (250nm) (Normalised)')
plt.xlabel('Beam Energy (keV)')
plt.ylabel('Intensity (Arb. Units)')
plt.plot(BeamEnergy,(Ray_AbsorbB_250 / max(Ray_AbsorbB_250)), label = 'I_emit (B)', marker = 'x', color = 'darkgoldenrod', linestyle = 'dotted')
plt.plot(BeamEnergy,(Ray_DetectB_250 / max(Ray_DetectB_250)), label = 'I_detected (B)', marker = 'x', color = 'darkorange', linestyle = 'dotted')
plt.plot(BeamEnergy,(Ray_AbsorbN_250 / max(Ray_AbsorbN_250)), label = 'I_emit (N)', marker = 'o', color = 'teal', linestyle = 'dotted')
plt.plot(BeamEnergy,(Ray_DetectN_250 / max(Ray_DetectN_250)), label = 'I_detected (N)', marker = 'o', color = 'blue', linestyle = 'dotted')
plt.legend()
